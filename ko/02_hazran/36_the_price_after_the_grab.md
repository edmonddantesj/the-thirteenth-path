# EP036. THE PRICE AFTER THE GRAB
...
주위 소리가 줄어드는 방식으로 알았다.

한꺼번에 조용해진 게 아니었다. 골목 안쪽부터 한 줄씩 줄었다. 값을 부르던 소리가 먼저 끊기고, 흥정하던 소리가 끊기고, 마지막에 구경하던 소리가 끊겼다.

파는 사람이 먼저 입을 닫고 구경하는 사람이 마지막까지 떠든다. 시온은 그 순서를 처음 봤다.

골목 입구 그림자 너머에서, 검은 천 아래 단단한 팔 하나가 먼저 보였다.

그리고 그 뒤로, 사람보다 통제를 먼저 믿는 눈이 천천히 이쪽을 향해 들어오고 있었다.