# EP039. THE BREATH SHE DID NOT SHOW
...
시온은 그 시선을 받는 순간 손이 재킷 쪽으로 가려는 걸 억지로 멈췄다.

저 눈이 보고 있는 게 그거였다. 뭘 들고 왔는지가 아니라 어디에 손이 가는지.
...
질문하러 들어가는 게 아니라, 이미 안쪽 질서 안으로 분류되러 들어가는 것.
...
시온은 그 뒤를 따라 안쪽으로 들어갔다.

문턱을 넘자 소리가 달라졌다. 바깥층에서는 값 부르는 소리가 제일 컸는데 여기서는 그게 없었다. 말소리는 있는데 숫자가 안 들렸다.

시온은 걸으면서 그걸 생각했다. 여기서는 값을 소리 내서 안 정한다.

소리 내서 안 정하면, 못 들은 사람은 끝까지 모른다.
