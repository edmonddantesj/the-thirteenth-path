# EP037. THE HAND THAT CUT THE NOISE
...
나심이 값을 매기고 길을 거르는 얼굴이라면, 이쪽은 누가 여기서 더 떠들 수 있는지, 누가 여기서 입을 다물어야 하는지를 정하는 손이었다.
...
그리고 그 안쪽 어딘가에는, 아카도 있을 거였다.

시온은 오늘 하루를 돌려 봤다.

이 도시에서 그 이름을 소리 내어 말한 사람이 하나도 없었다.

바깥층에서는 애 입을 막았다. 하룬은 알면서도 저 이름이라고만 했고 나심은 아예 안 꺼냈다.

알아서 안 부르는 거였다.

모르는 이름이면 물어보면 된다. 다들 아는데 아무도 안 부르는 이름은 물어볼 데가 없다. 물어보는 순간 물어본 사람이 표시가 된다.

시온은 바깥층에서 자기가 그 이름을 몇 번 말했는지 세어 봤다.

두 번이었다.

이 이름은 찾는다고 끝나는 이름이 아니었다.

잘못 찾으면 그대로 먹히는 이름이었다.