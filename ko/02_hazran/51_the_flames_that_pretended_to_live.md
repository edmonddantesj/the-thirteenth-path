# EP051. THE FLAMES THAT PRETENDED TO LIVE
...
살아 있는 불씨처럼 버틴 게 아니라, 손에 잡히자마자 다 타 버린 미끼 같은 꺼짐.
...
그건 잔혹해서가 아니라, 시온 말이 맞았다는 확인이었다.

시온은 그 한마디에 오히려 더 조용해졌다.

이 구간에선 자기 눈 하나가, 그냥 길을 읽는 보조가 아니라 누가 속고 누가 안 속는지를 가른다.
...
카엘은 그 대답이 계산에서 나온 게 아니라는 걸 알았다.

죽는 척을 안 하는 쪽이라는 건, 죽는 척을 하는 걸 여러 번 봤다는 뜻이다. 기록과 구조와 반복 패턴을 너무 많이 본 눈은 저런 종류의 거짓말에 익숙해진다.
...
주변 불빛들이 다 한 번쯤 살아 있는 척 흔들릴 때, 저건 그냥 버티고 있었다.
...
관람대 끝에서 아카가 난간 쪽으로 한 걸음 갔다.

다들 오른쪽 큰 불빛 쪽을 보고 있었다. 아카는 그쪽을 안 봤다. 눈이 경기장 왼쪽 아래에 붙어 있었고, 붙은 채로 안 움직였다.

옆에 나히라가 있었다.

아카가 나히라 쪽으로 고개를 반쯤 돌렸다.

“안 보는 사람이 가져.”

나히라는 아무 말도 안 했다. 대신 아카가 보는 쪽을 같이 봤다.

거기에 스키프 하나가 낮게 눌려 들어가고 있었다. 관중 중에 그쪽을 보는 사람은 거의 없었다.

경기장 안에서 시온은 그 말을 못 들었다.
...
근데 바로 그 순간, 열기층 아래 공기가 한번 크게 일그러졌다.
...
검붉은 활주기도 거의 같은 순간 안쪽으로 파고들었고, 북쪽에서 카엘과 세른이 타는 활주기는 한 박자 늦지만 더 안정된 선으로 접근하고 있었다.

살아남은 팀 셋이, 마침내 거의 같은 불씨 후보 앞에서 부딪히기 직전이었다.

그리고 시온은 알았다.

여기서부터는, 이 경기의 규칙만으로는 안 끝날 수도 있다.