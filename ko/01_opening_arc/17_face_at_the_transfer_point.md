# EP017. FACE AT THE TRANSFER POINT
...
그리고 왼손 엄지와 검지 안쪽만 굳은살이 두꺼웠다. 오른손은 아니었다. 오른손잡이가 왼손 두 손가락만 그렇게 쓰려면, 오른손으로 공구를 잡고 왼손으로는 계속 무언가를 붙들고 있어야 한다.

부품을 붙들고 있는 손이다.

세른은 그 손을 몇 년쯤 그렇게 썼을지 계산하려다 그만뒀다. 그건 지금 필요한 수치가 아니었다.
...
한지우는 램프 앞에서 사람 수를 셌다.

시온, 서린, 검은 외투, 그 옆의 조용한 쪽. 넷.

그러고는 요나 쪽을 봤다. 요나는 대합칸 안쪽으로 들어오지 않고 접속교 입구 근처에 그대로 서 있었다. 짐도 안 들고 있었다.

한지우는 다시 계기판으로 시선을 돌리며 아무 말도 안 했다.

물자를 다시 세지도 않았다. 처음부터 넷으로 계산해 놨던 것이다.
