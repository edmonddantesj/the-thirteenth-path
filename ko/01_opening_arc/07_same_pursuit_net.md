...
서린은 그 말에서 「배웠다」만 따로 들었다.

누군가는 이 길로 도망쳤고, 누군가는 그 도망을 배워서 적어 두었다. 지금 넷이 같이 기어가고 있는 이 배관이 그 두 종류 사람이 같이 쓴 길이었다.
...
<!-- DASH-OK: 정본 EP007:163 그대로. 개정이 만든 줄표가 아니다 -->
“확신할 수 없—”
...
여기는 손전등을 켤 수 없는 자리였다. 위에서 빛을 훑고 있으니까. 그래서 발로 더듬어 내려가는 게 정상이었다.

시온은 더듬지 않았다.

여덟째 칸이 부식돼 통째로 비어 있는 게 위에서부터 보였고, 그 옆 배관 이음매가 살아 있는 것도 보였다. 발끝이 빈 칸을 지나쳐 그 이음매를 정확히 디뎠다. 소리가 거의 안 났다.
...
서린이 두 번째로 내려왔다.
그녀도 더듬지 않았다. 빈 칸을 그냥 넘기고 시온이 디딘 이음매를 그대로 밟았다. 내려오자마자 옆으로 한 칸 비켜서며 위를 향해 말했다.
...
그는 여덟째 칸에서 한 번 멈췄다. 발을 내렸다가, 없는 걸 확인하고, 도로 올렸다. 그러고 나서 손으로 옆을 더듬어 이음매를 찾았다. 시간이 걸렸다.
...
“당신들은 어떻게 봅니까. 여기 아무것도 안 보이는데.”

아무도 대답하지 않았다.

아테르는 그 침묵도 오늘 두 번째라는 걸 알았다.
